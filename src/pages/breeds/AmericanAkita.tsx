          ...
          <div className="p-8 md:p-16 text-center mb-16">
            <div className="mb-8">
              <img 
                ...
                alt={t('americanAkita')}
                className="w-full max-w-2xl mx-auto h-64 md:h-96 object-cover object-center rounded-2xl hover:scale-105 transition-transform duration-300"
                style={{ aspectRatio: '16/9' }}
              />
            </div>
            
            <h1 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6" style={{ fontFamily: 'HonorSans, sans-serif' }}>
              <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">{t('americanAkita')}</span>
            </h1>
            ...
            <div className="flex justify-center">
              <a 
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 md:px-8 py-3 rounded-2xl font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 inline-flex items-center justify-center"
              >
