          ...
          <div className="p-8 md:p-16 text-center mb-16">
            ...
            <div className="flex justify-center">
              <a 
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 md:px-8 py-3 rounded-2xl font-semibol transition-colors duration-200 shadow-lg hover:shadow-xl hover:scale-105 inline-flex items-center justify-center"
              >
