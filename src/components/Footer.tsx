...
const Footer = ({ onNavigateToSection }: FooterProps) => {
  ...
  const quickLinks = [
    ...
    { label: 'Our Dogs', id: 'our-dogs' },
    { label: 'Info Hub', id: 'info' },
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-2xl font-bold gradient-text">Prestige Pups</span>
            </div>
            <p className="text-slate-300 leading-relaxed">
              Excellence in breeding, devoted to connecting loving families with exceptional canine companions 
              for over two decades.
            </p>
            <div className="flex space-x-4">
              <div className="w-10 h-10 bg-slate-800 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-colors cursor-pointer">
              ...
              <div className="w-10 h-10 bg-slate-800 rounded-xl flex items-center justify-center hover:bg-gradient-to-r hover:from-purple-500 hover:to-pink-500 transition-all cursor-pointer">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-3 text-slate-300">
              <div className="flex items-center space-x-3">
                <span>📧</span>
                <span>info@prestigepups.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <span>📱</span>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-400 text-sm">
            © {currentYear} Prestige Pups. All rights reserved.
          </p>
          <p className="text-slate-500 text-xs mt-2 md:mt-0">
            Designed with inspiration from Apple's philosophy of elegance and quality.
          </p>
        </div>
      </div>
    </footer>
