...
const OurDogsSection = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
        {breeds.map((breed, index) => (
          <Link key={breed.name} to={breed.path}>
            <Card className="liquid-glass overflow-hidden group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
      ...
      {/* Call to Action */}
      <div className="liquid-glass p-12 text-center bg-gradient-to-r from-blue-50/50 to-gray-50/50">
