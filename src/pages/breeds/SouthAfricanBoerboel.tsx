  ...
  const availableDogs = [
    {
      ...
      gender: "Male",
      price: "$3,500",
      description: "Impressive male with excellent protection instincts and gentle family nature.",
      image: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      features: ["Protection Trained", "Health Guarantee", "Microchipped", "Champion Bloodline"]
    },
    {
      id: 2,
      name: "African Queen",
      ...
      gender: "Female",
      price: "$3,800",
      description: "Beautiful female with calm temperament and excellent conformation.",
      image: "https://images.unsplash.com/photo-1587300003388-59208cc962cb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      features: ["Show Potential", "Health Guarantee", "Socialized", "Excellent Temperament"]
    }
  ];
