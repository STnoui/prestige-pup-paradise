...
const translations = {
  ...
  bg: {
    ...
    newAboutText2: 'Нашата програма за развъждане се фокусира върху качеството, а не върху количеството. Всяко куче под нашата грижа получава индивидуално внимание, правилно хранене и цялостно наблюдение на здравето. Ние сме посветени на производството на здрави, добре социализирани кученца, които ще станат обичани членове на семейството.',
