    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-6 max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="relative backdrop-blur-xl bg-white/30 dark:bg-black/30 rounded-3xl p-12 md:p-16 lg:p-20 border border-gray-200/50 dark:border-gray-700/50 shadow-lg font-normal text-[16px] pt-[10px] pb-[10px] pl-[21px] pr-[21px]">
            <h1 
