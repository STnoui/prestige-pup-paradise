  ...
  return (
    <div className="max-w-7xl mx-auto px-6 lg:px-8">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6" style={{ fontFamily: 'HonorSans, sans-serif' }}>
        ...
        <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed" style={{ fontFamily: 'HonorSans, sans-serif' }}>
          {t('breedsSectionDesc')}
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        {breeds.map((breed, index) => (
          <Link key={breed.name} to={breed.path}>
            <Card className="bg-white dark:bg-black border border-gray-200 dark:border-gray-700 overflow-hidden group hover:shadow-2xl hover:shadow-blue-200/50 dark:hover:shadow-blue-400/30 transition-all duration-500 hover:-translate-y-2 hover:border-blue-500 dark:hover:border-blue-400 rounded-3xl animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
              ...
              <div className="p-6 bg-white dark:bg-black">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors" style={{ fontFamily: 'HonorSans, sans-serif' }}>
                  {breed.name}
                </h3>
                <p className="text-gray-600 dark:text-gray-200 text-sm mb-4" style={{ fontFamily: 'HonorSans, sans-serif' }}>{breed.description}</p>
                
                <div className="flex items-center text-blue-600 dark:text-blue-300 font-semibold text-sm group-hover:text-blue-500 dark:group-hover:text-blue-200" style={{ fontFamily: 'HonorSans, sans-serif' }}>
                  {t('learnMore')}
