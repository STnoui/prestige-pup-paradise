        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <Card className="liquid-glass p-16 text-center">
            ...
            <h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-6">
              German <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Shepherd</span>
            </h1>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 mb-8 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                ...
                Contact us on Facebook to discuss our current and upcoming German Shepherd litters.
              </p>
