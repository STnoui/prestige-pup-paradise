      ...
      <main className="pt-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <Card className="apple-card p-16 text-center">
            <div className="mb-8">
              <img 
                src="https://images.unsplash.com/photo-1589941013453-ec89f33b5e95?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2065&q=80"
                alt="German Shepherd"
            ...
            <h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-6">
              German <span className="bg-gradient-to-r from-gray-600 to-gray-800 bg-clip-text text-transparent">Shepherd</span>
            </h1>
            
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              Large, athletic dogs, German Shepherds stand 22 to 26 inches at the shoulder and are longer than they are tall. When trotting, they show effortless, efficient gait that covers the ground with long strides. They can be aloof with strangers but are never timid.
            </p>

            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 mb-8 border border-gray-200 dark:border-gray-700">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">In Development!</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                We're carefully planning our German Shepherd breeding program with emphasis on working ability, health, and temperament. 
                Our German Shepherd program will launch in 2025 with exceptional bloodlines.
              </p>
